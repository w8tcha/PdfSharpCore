...
public class PdfSecurity
{
    ...
    [TestCase(PdfDocumentSecurityLevel.Encrypted40Bit, "hunter1")]
    [TestCase(PdfDocumentSecurityLevel.Encrypted128Bit, "hunter1")]
    ...
    [TestCase(@"protected-ilovepdf.pdf", "test123")]
        
    // https://www.adobe.com/de/acrobat/online/password-protect-pdf.html, 128 bit, /V 4 /R 4
    [TestCase(@"protected-adobe.pdf", "test123")]

    // https://pdfencrypt.net, 256 bit, /V 5 /R 5
    [TestCase(@"protected-pdfencrypt.pdf", "test123")]
    ...
    [TestCase(@"protected-sodapdf.pdf", "test123")]
    public void CanReadPdfEncryptedWithSupportedAlgorithms(string fileName, string password)
    {
        ...
        TestContext.Out.WriteLine("Creator : {0}", doc.Info.Creator);
        TestContext.Out.WriteLine("Producer: {0}", doc.Info.Producer);
    }
}